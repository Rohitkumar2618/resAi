...
import ResScoreGuidepageInSights from "./ResScoreGuidepageInSights";

const ResScoreGuidepageProfile = () => {
  ...
  const renderStepComponent = () => {
    switch (currentStep) {
      case 1:
        return <ResScoreProfileCrisis />;
      case 2:
        return <ResScoreProfileEconomic />;
      case 3:
        return <ResScoreGuidepageInSights />;
      default:
        return null;
    }
  };
  ...
  const stepClasses = (step) => {
    return `w-[20px] h-[20px] flex items-center justify-center rounded-full text-[12px] cursor-pointer ${
      currentStep === step
  ...
  const stepLabelClasses = (step) => {
    return `text-[14px] ml-2 font-[14px] cursor-pointer ${
...
export default ResScoreGuidepageProfile;
